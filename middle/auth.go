...
func MiddlewareAuthToken(ctx iris.Context) {
	...
	excludeLists := []string{
		...
		"controllers.OauthController.AllWbBy",       // 微博接入
		"controllers.OauthController.AllQqBy",       // 腾讯QQ接入
		"controllers.CommonController.Get",          // 测试模块
		...
		"controllers.NotepadController.PutBy",       // 更新纸张
		"controllers.NotepadController.GetShareBy",  // 分享纸张
		"main.main.Handler.func8",                   // 实时通信
		"controllers.WebsocketController.Get",       // Websocket
	}
